...
const properties = [
  ...
  const rent =[
    {
      id: 1,
      image: house1 , // Replace with actual image path
      label: "RENT",
      address: "17081 Gahanga Street",
      location: "kicukiro",
      price: "$750,000",
